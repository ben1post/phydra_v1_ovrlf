...
% COMMENTS FROM ESTEBAN:
% 2 Use Cases! simplify! 

% present models traditionally first (like in appendix)
% and then add another paragraph (very simple) how it is implemented in phydra
% 

% take care with all the traditionalist points: Units, forcing (+data) presentation, proper citation!

% keep draft short! 20 pages total
