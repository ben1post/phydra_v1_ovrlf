...
\Author[1]{alphabetical order (for now): Agostino}{Merico}
...
\section{Detailed Model Descriptions}    %% Appendix A

\subsection{Model Equations and Parameters}     %% Appendix A1, A2, etc.
