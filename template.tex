...
% This custom function allows context-dependent rendering of the bibliography in subfiles:
\def\biblio{\bibliographystyle{copernicus}\bibliography{references.bib}}  % *Modification: added `\main/` to specify relative file location.

\begin{document}
\def\biblio{} % defines this as main file for bibliography (needed because of subfile structure)
...
\clearpage
\subfile{Sections/02_phydra}
\clearpage
\subfile{Sections/03_modelexamples}
\clearpage
\subfile{Sections/04_discussion}
\clearpage
\subfile{Sections/05_conclusions}
...
\subfile{Appendix/01.1_appendix}

\clearpage
% appendix for Use Case 2
\subfile{Appendix/01.2_appendix}

\clearpage
% appendix for Use Case 3
\subfile{Appendix/01.3_appendix}
