...
Xarray-simlab-ODE (XSO) provides a framework to build and customize models based on differential equations from flexible components. The XSO framework was developed in conjunction with Phydra, but is domain-agnostic and can be used to build any type of model based on differential equations.
