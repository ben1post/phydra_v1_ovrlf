...
\title{phydra V1 - a flexible open-source marine ecosystem modeling python package}
...
\subsection{Use Case I: NPZD}
% I could try to create one jupyter notebook for each of the results and examples
% these leverage the package! and provide clear usage examples, well documented
TEXT
...
\subsection{Use Case II: Size-based trophic structure}
TEXT


\subsubsection{Model Structure: Size-based trophic structure}
TEXT
...
- package architecture should be merged with other open-source python efforts (xsimlab, veros-bgcm)

- want to make the first step, hoping that people will adopt and contribute

- clearly: should add 1D -> 3D capabilities in the future
