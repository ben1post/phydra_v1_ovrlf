...
%% MERGE THE TWO PARAGRAPHS BELOW INTO A SHORT SINGLE PARAGRAPH! %%%%%%%%%%%%%%%%%
...
\codeavailability{XSO and Phydra packages are open source and available under a BSD-3 license on GitHub.} %% use this section when having only software code available
