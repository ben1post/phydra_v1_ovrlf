...
\copyrightstatement{Phydra and XSO are published open-source with a BSD-3-Clause license for open access and fair usage.} %% This section is optional and can be used for copyright transfers.
