...
\begin{abstract}
I am using the Copernicus latex template in order to make sure it corresponds to what the submitted manuscript will render the latex input as. Following, I will write up all equations and parameters used in my simplified EMPOWER model in the \textit{phydra} package.
\end{abstract}
...
The current model setup is based on the EMPOWER model \citep{Anderson2015c}.
...
\tophline
$V_P$ & max photosynthesis rate & 2 & 3 & 4 \\
$k_N$ & blörk \\
%\middlehline
