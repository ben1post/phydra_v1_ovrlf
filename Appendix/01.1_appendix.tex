...
\usepackage{xr}
% Add other subfiles below to import labels
\externaldocument{../Sections/03_modelexamples} 
%\myexternaldocument{../Sections/02_phydra} 
...
In this appendix the model use cases are described mathematically, independent of their specific implementation in the phydra package. For documented model code, please see the examples folder on the phydra repository (\url{https://github.com/ben1post/phydra/tree/master/examples}).
