...
% d) xs.Model, xs.create_setup, xsimlab.run()
The model setup parameters and runtime parameters are given in table X.
...
\begin{table*}[t]
\caption{Arguments passed to phydra.Model with the supplied label with a short description of the function.}
